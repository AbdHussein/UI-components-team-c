...
import AvatarContent from "./Content/AvatarContentLayout";
import CardContentLayout from "./Content/CardContentLayout";
import DialogContent from "./Content/DialogContentLayout";
import SkeletonContent from "./Content/SkeletonContentLayout";
