...
const SkeletonContent = () => {
  return (
    <div>
      <Typography variant="h1" id="Skeleton">
        Skeleton
      </Typography>
      ...
      <Typography variant="h1" id="Usage">
        Usage
      </Typography>
      <Typography variant="body1" gutterBottom>
      ...
      <Typography variant="h2" id="Animations">
        Animations
      </Typography>
      <Typography variant="body1" gutterBottom>
      ...
      <Typography variant="h2" id="Pulsate example">
        {" "}
        Pulsate example{" "}
      </Typography>
      <ComponentOverview style={{ flexDirection: "column" }}>
      ...
      <Typography variant="h2" id=" Wave example">
        {" "}
        Wave example
      </Typography>
      <ComponentOverview
      ...
      >
        ...
        >
          ...
          <img src={skeleton5} width={250} height={118} alt="" />
      ...
      <Typography variant="h2" id="Color">
        Color{" "}
      </Typography>
      <Typography variant="body1" gutterBottom>
