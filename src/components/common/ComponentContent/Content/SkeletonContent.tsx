  ...
  return (
    <div>
      <div>
        ...
        <Typography variant="body1" gutterBottom>
          By default, the skeleton pulsates, but you can change the animation to
          a wave or disable it entirely.
        </Typography>
        <ComponentOverview
        ...
        <Typography variant="h3" id="Sizes">
          Inferring dimensions
        </Typography>
        <Typography variant="h4" id="Sizes">
          In addition to accepting width and height props, the component can
        ...
        <ComponentOverview style={{ flexDirection: "column" }}>
          <ComponentOverview style={{ border: "none" }}>
            <Skeleton height={50} />
            <Typography variant="h1" id="Sizes">
              {" "}
              h1{" "}
            </Typography>
          </ComponentOverview>
          ...
          <ComponentOverview style={{ border: "none" }}>
            <Skeleton height={16} />
            <Typography variant="h5" id="Sizes">
              {" "}
              body1{" "}
            </Typography>
          </ComponentOverview>
          <ComponentOverview style={{ border: "none" }}>
            <Skeleton />
            <Typography variant="h6" id="Sizes">
              {" "}
              caption{" "}
            </Typography>
          </ComponentOverview>
        ...
        <Typography variant="h4" id="Sizes" style={{ marginTop: "30px" }}>
          ...
          width and height. In these instances, you can pass children and it
          will infer its width and height from them.
        </Typography>
        <CodeSnippet
          full_code={`
        loading ? (
        ...
        <Typography variant="body1" gutterBottom>
          ...
          background-color CSS property.This is especially useful when on a
          black background (as the skeleton will otherwise be invisible).
        </Typography>
